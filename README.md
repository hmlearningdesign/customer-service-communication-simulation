...
This project was designed to create a safe practice environment where learners can respond to realistic customer scenarios, make decisions, and receive structured feedback based on their choices.
